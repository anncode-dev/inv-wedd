...
use App\Nova\Actions\NewsApproval;
...
{       
    ...
    public static function indexQuery(NovaRequest $request, $query)
    {
        ...
        return $query->where('type', 1) // Hanya News
                 ->with('creator') // Pastikan creator dimuat
    ...
    public function fields(NovaRequest $request)
    {
        return [
            ...
            Boolean::make('Highlight')->default(false)
                ->sortable(),
            ...
            Text::make('View in Frontend', function() {
                ...
                $url = $base."/berita/detail/".Str::slug($this->title);
    ...
    public function actions(NovaRequest $request)
    {
        ...
        $act = [];
        if($request->user()->isSuperAdmin() || $request->user()->isSuperVisor()){
            $act = [new NewsApproval()];
        }
