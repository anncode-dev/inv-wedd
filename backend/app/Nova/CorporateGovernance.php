...
class CorporateGovernance extends Resource
{   
    ...
    {
        return '/resources/corporate-governance-categories/'.$request->get('viaResourceId');
    }
    ...
    {   
        ...
        $c = \App\Models\CorporateGovernanceCategory::whereNull('type')->where('id',$id)->first();
        ...
        return [
            ...
            Select::make('Category', 'corporate_governance_category_id')->searchable()
                ->options(\App\Models\CorporateGovernanceCategory::whereNull('type')->pluck('title', 'id'))->displayUsingLabels()->default($id)
