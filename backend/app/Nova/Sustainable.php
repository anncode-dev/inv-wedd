...
class Sustainable extends Resource
{   
    ...
    {
        return '/resources/sustainable-categories/'.$request->get('viaResourceId');
    }
    ...
    {   
        ...
        $c = \App\Models\CorporateGovernanceCategory::where('type',2)->where('id',$id)->first();
        ...
        return [
            ...
            Select::make('Category', 'corporate_governance_category_id')->searchable()
                ->options(\App\Models\CorporateGovernanceCategory::where('type',2)->pluck('title', 'id'))->displayUsingLabels()->default($id)
