...
class ProfileCategory extends Resource
{   
    public static function label() {
        return 'Tentang Bank Kalsel';
    }
    /**
     * The model the resource corresponds to.
     *
     * @var class-string<\App\Models\ProfileCategory>
     */
    public static $model = \App\Models\ProfileCategory::class;
    ...
    public function fields(NovaRequest $request)
    {
        return [
            ...
            Markdown::make('Short Description','short_description') 
            ...
            HasMany::make('Detail Information', 'detail', 'App\Nova\AboutUs')
        ];
    }
