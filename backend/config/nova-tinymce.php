...
return [
    ...
    */
    ...
    'default_options' => [
        ...
        'path_absolute' => '/',
        'plugins' => [
            'lists','preview','anchor','pagebreak','image','wordcount','fullscreen','directionality','table','code'
        ],
        'toolbar' => 'undo redo | styleselect | bold italic forecolor backcolor | alignleft aligncenter alignright alignjustify | table image | bullist numlist outdent indent | link',
        'relative_urls' => false,
        'use_lfm' => true,
        'use_dark' => true,
        'lfm_url' => 'filemanager',
